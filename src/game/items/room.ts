...
export function roomColor(state: State): Color {
    ...
    else if (red && green && !blue) { return 'yellow'; }
    else if (red && !green && blue) { return 'magenta'; }
    else if (red && !green && !blue) { return 'red'; }
    else if (!red && green && blue) { return 'cyan'; }
    else if (!red && green && !blue) { return 'green'; }
    else if (!red && !green && blue) { return 'blue'; }
    else if (!red && !green && !blue) { return 'black'; }
    else {
        throw new Error();
    }
}
